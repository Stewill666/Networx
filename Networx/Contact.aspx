    ...
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:Button ID="btnSave" runat="server" Text="Submit/Update" OnClick="btnSave_Click" />
      
                    <asp:Button ID="btnDelete" runat="server" Text="Delete" OnClick="btnDelete_Click" style="margin-right: 1px" />
